...
export function ColorPicker({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div
          className="mr-2 size-4 shrink-0 rounded-full shadow-sm"
          style={{ backgroundColor: colorInput }}
        />
        <span className="min-w-0 flex-grow truncate">{trimColorString(colorInput)}</span>
        ...
        >
          ...
          <div className="flex items-center space-x-2">
            ...
            <Input
              ...
              className="h-8 flex-grow px-2 text-sm"
